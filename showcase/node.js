!(function (exports){
 ...
 var usb=COLOR([0,0,0])( T([0])([-0.1])( STRUCT([SIMPLEX_GRID([[0.1],[-21.5,1,-1,1],[-0.5,0.5] ]) ]) ));
 var led=COLOR([0,1,0])( T([0])([-0.1])( STRUCT([SIMPLEX_GRID([[0.1],[-17,0.1,-0.3,0.11],[-0.4,0.1] ]) ]) ));
 
 var hdd=COLOR([0,0,0])( T([0])([-0.1])( STRUCT([SIMPLEX_GRID([[0.1],[-0.5,0.8,-0.5,0.8,-0.5,0.8,-0.5,0.8],[-0.2,0.1] ]) ]) ));
 var aria=COLOR([0,0,0])(STRUCT([SIMPLEX_GRID([[-25,0.1],[-1,0.02,-1.5,0.02,-1.5,0.02,-1.5,0.02,-1.5,0.02],[-1,0.46]]) , SIMPLEX_GRID([[-25,0.1],[-1,6.1],[-1,0.02,-0.2,0.02,-0.2,0.02]]) ,SIMPLEX_GRID([[-25,0.1],[-1,24.18],[-2,0.02,-0.2,0.02,-0.2,0.02,-0.2,0.02]]) ,SIMPLEX_GRID([[-25,0.1],[-1,0.02,-3,0.02,-3,0.02,-3,0.02,-3,0.02,-3,0.02,-3,0.02,-3,0.02,-3,0.02,-3],[-2,0.68]])]));
 var eth=COLOR([0,0,0])(STRUCT([SIMPLEX_GRID([[-25,0.1],[-10,0.2,-1,0.2],[-0.7,0.8]]) , SIMPLEX_GRID([[-25,0.1],[-10,1.4],[-0.7,0.2]]), SIMPLEX_GRID([[-25,0.1],[-10,0.5,-0.4,0.5],[-1.3,0.2]]) ]));
